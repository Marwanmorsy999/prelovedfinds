    ...
    <div>
      <section className="relative">
        <div className="relative aspect-[4/5] w-full overflow-hidden bg-surface md:aspect-[16/9]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
            <p className="font-mono text-[11px] font-medium uppercase tracking-[0.3em] text-paper/80">Cairo</p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-8">
        <div className="mb-10 flex items-end justify-between border-b border-hairline pb-4">
          <div>
            <p className="font-mono text-[11px] font-medium uppercase tracking-[0.2em] text-rust">Just In</p>
            <h2 className="mt-2 font-display text-3xl uppercase tracking-tight text-ink md:text-5xl">New Picks</h2>
          </div>
          <Link to="/shop" className="text-[11px] font-semibold uppercase tracking-[0.2em] text-ink hover:text-rust">
            View all →
          </Link>
        </div>
